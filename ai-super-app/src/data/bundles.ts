...
export const bundles: Bundle[] = [
  {
    ...
    tools:[
      ...
      {id:"recipe",nameKey:"tools.daily.recipe",emoji:"🍳",type:"image-upload",
        ...
        aiPrompt:"あなたは料理研究家です。冷蔵庫の写真から使える食材を特定し、簡単に作れるレシピを3つ提案してください。調理時間と難易度も記載してください。アレルギーや食事制限があれば考慮してください。"}
    ]
  },
  {
  ...
  },
  {
    ...
    tools:[
      {id:"babyname",nameKey:"tools.parent.babyname",emoji:"👶",type:"form-input",
        ...
        fields:[{name:"姓",placeholder:"例: 田中"},{name:"性別",placeholder:"例: 男の子、女の子、どちらでも"},{name:"希望する響き",placeholder:"例: 明るい、和風"},{name:"文字数",placeholder:"例: 2文字"}],
        aiPrompt:"あなたは命名の専門家です。姓との相性、画数、意味、性別を考慮した名前を5つ提案してください。それぞれの由来と画数も記載してください。"},
  ...
  },
  {
    ...
    tools:[
      ...
      {id:"compare",nameKey:"tools.realestate.compare",emoji:"🔍",type:"form-input",
        ...
        fields:[{name:"候補1",placeholder:"例: 渋谷区 2LDK 家賃15万"},{name:"候補2",placeholder:"例: 世田谷区 2LDK 家賃12万"},{name:"通勤先",placeholder:"例: 新宿駅"},{name:"重視ポイント",placeholder:"例: 通勤時間、子育て環境"}],
        aiPrompt:"あなたは住まい選びのアドバイザーです。複数の物件候補の特徴を比較整理し、通勤時間も考慮してライフスタイルに合った選択のポイントを提案してください。"},
  ...
  },
  {
    ...
    tools:[
      {id:"budget",nameKey:"tools.money.budget",emoji:"📊",type:"form-input",
        ...
        fields:[{name:"月収",placeholder:"例: 30万円"},{name:"家族構成",placeholder:"例: 夫婦+子供1人"},{name:"固定費",placeholder:"例: 家賃8万、光熱費1.5万"},{name:"貯金目標",placeholder:"例: 月5万円"}],
        aiPrompt:"あなたはファイナンシャルプランナーです。家族構成と収支情報から最適な予算配分と節約ポイントを提案してください。"},
  ...
  },
  {
    ...
    tools:[
      ...
      {id:"petfood",nameKey:"tools.pet.petfood",emoji:"🦴",type:"form-input",
        ...
        fields:[{name:"ペットの種類",placeholder:"例: 柴犬"},{name:"年齢・体重",placeholder:"例: 3歳 10kg"},{name:"健康状態・アレルギー",placeholder:"例: 特になし / 鶏肉アレルギー"},{name:"運動量",placeholder:"例: 毎日散歩30分"}],
        aiPrompt:"あなたはペット栄養士です。ペットの種類・年齢・体重・健康状態・アレルギー・運動量から最適な食事プランとおすすめフードを提案してください。"},
  ...
  },
  {
    ...
    tools:[
      {id:"plan",nameKey:"tools.travel.plan",emoji:"🗺️",type:"form-input",
        ...
        fields:[{name:"目的地",placeholder:"例: バルセロナ"},{name:"期間",placeholder:"例: 4泊5日"},{name:"人数",placeholder:"例: 大人2人、子供1人"},{name:"予算",placeholder:"例: 30万円"},{name:"興味",placeholder:"例: 建築、グルメ"}],
        aiPrompt:"あなたはプロの旅行プランナーです。人数・条件に合った具体的で実用的な日ごとの旅行プランを作成してください。実在する具体的なスポット名・レストラン名・ホテル名を使い、Google Maps等のURLも可能な限り含めてください。移動手段、所要時間、費用目安、おすすめの食事スポットも記載してください。"},
      {id:"pack",nameKey:"tools.travel.pack",emoji:"🧳",type:"form-input",
        ...
        fields:[{name:"目的地",placeholder:"例: ハワイ"},{name:"期間",placeholder:"例: 5日間"},{name:"季節",placeholder:"例: 夏"},{name:"宿泊タイプ",placeholder:"例: ホテル、民泊、キャンプ"}],
        aiPrompt:"あなたは旅行準備の専門家です。目的地・期間・宿泊タイプに合った持ち物リストを作成してください。必需品と便利グッズに分けてください。"},
  ...
  },
  {
    ...
    tools:[
      ...
      {id:"menu",nameKey:"tools.cook.menu",emoji:"📋",type:"form-input",
        ...
        fields:[{name:"人数",placeholder:"例: 4人家族"},{name:"制限・アレルギー",placeholder:"例: 卵アレルギー、ベジタリアン"},{name:"調理スキル",placeholder:"例: 初心者、得意"},{name:"1食の調理時間",placeholder:"例: 30分以内"},{name:"予算",placeholder:"例: 週5000円"}],
        aiPrompt:"あなたは献立アドバイザーです。アレルギー・調理スキル・時間制約に合った1週間の献立を作成してください。買い物リストも付けてください。"},
  ...
  },
  {
    ...
    tools:[
      {id:"plan",nameKey:"tools.wedding.plan",emoji:"📋",type:"form-input",
        ...
        fields:[{name:"時期",placeholder:"例: 来年6月"},{name:"人数",placeholder:"例: 80人"},{name:"予算",placeholder:"例: 300万円"},{name:"スタイル",placeholder:"例: ガーデンウェディング"},{name:"宗教・文化・その他",placeholder:"例: 神前式希望、アレルギー対応必要"}],
        aiPrompt:"あなたはウェディングプランナーです。宗教・文化的な要望やアレルギー対応も含め、条件に合った結婚式の全体プランを提案してください。タイムライン、会場選び、演出のアイデアを記載してください。"},
  ...
  },
  {
    ...
    tools:[
      {id:"plan",nameKey:"tools.date.plan",emoji:"📍",type:"form-input",
        ...
        fields:[{name:"エリア",placeholder:"例: 表参道〜渋谷"},{name:"時間帯",placeholder:"例: 午後〜夜"},{name:"交通手段",placeholder:"例: 電車、車"},{name:"雰囲気",placeholder:"例: おしゃれ、カジュアル"},{name:"予算",placeholder:"例: 1万円"}],
        aiPrompt:"あなたはデートプランナーです。交通手段・条件に合ったデートコースを提案してください。時間配分、お店の提案、会話のネタも記載してください。"},
